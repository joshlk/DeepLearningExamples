    ...
    if args.action == 'download':
        ...
        if args.dataset == 'bookscorpus':
            ...
            if args.skip_wikiextractor == 0:
                path_to_wikiextractor_in_container = 'python3 -m wikiextractor.WikiExtractor'
        ...
        def create_record_worker(filename_prefix, shard_id, output_format='tfrecord'):
            bert_preprocessing_command = 'python3 /home/joshl/git/DeepLearningExamples/PyTorch/LanguageModeling/BERT/create_pretraining_data.py'
